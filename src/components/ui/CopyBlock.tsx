...
export function CopyBlock({ command }: { command: string }) {
  ...
  return (
    <button
      ...
      className="group flex w-full items-center justify-between gap-4 rounded-lg border border-border bg-surface/60 px-4 py-3 text-left font-mono text-sm text-fg transition-colors hover:border-accent/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
    >
